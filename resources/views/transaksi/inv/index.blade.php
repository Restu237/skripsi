                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="pt-2"><input type="number" min="0" max="100"
                                                            value="0" name="diskon" id="diskon" class="form-control form-control-sm col-md-4"></input>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="pt-2"><b>Total</b></td>
                                                        <td class="pt-2"><input readonly id="total"
                                                                class="form-control form-control-sm"></input></td>
                                                    </tr>
                                                    <tr>
                                                        <td><input id="ppn" type="radio" name="ppn" value="0.10"> PPN 10%<br>
                                                        </td>

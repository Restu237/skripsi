            ...
            <div class="row header">
                <div class="col">
                    ...
                    <div class="judul-lap">
                        ...
                        <h5 class="pt-2"><b><u>Delivery Order</u></b></h5>
                        <p>
                        Nomor Delivery Order: <b>{{$data->kd_do}}</b>
                        <br class="pt-1">
                        </p>
                        @php
                        $tanggal1 = $data->tanggal;
                        $timestamp = strtotime($tanggal1);
                        $tanggaldo = date('d F Y', $timestamp);
                        @endphp
                        <p>
                            Tanggal : <b>{{$tanggaldo}}</b>
                            <br class="pt-1">
                        </p>
                    ...
                    <div class="total-kalkulasi d-flex">
                        ...
                        <div class="ml-auto">
                            <table class="table">
                                <tr>
                                    <td><b>Total Qty &nbsp;:</b></td>
                                    <td><b>{{$transaksido->sum('qty')}}</b></td>
                                </tr>
                                <tr>
                                    <td><b>Total Item :</b></td>
                                    <td><b>{{$transaksido->count()}}</b></td>
                                </tr>
                            </table>
                        </div>
